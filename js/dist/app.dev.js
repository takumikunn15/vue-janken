...
var Janken = {
  ...
  methods: {
    fight: function fight(myHand) {
      var handName = this.hand; // 敵の手をランダムに決める
      // 0 1 2いずれかをランダムに選択

      var index = Math.floor(Math.random() * Math.floor(3)); // あいての手をenemyHandに代入

      this.enemyHandImageIndex = index; // 自分の手と比較する関数
